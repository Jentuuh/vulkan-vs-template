...
namespace vvt {
	...
	// Render loop
	void SimpleRenderSystem::renderGameObjects(VkCommandBuffer commandBuffer, VkDescriptorSet globalDescriptorSet, std::vector<VvtGameObject> &gameObjects, const VvtCamera& camera, const float frameDeltaTime, VvtGameObject* viewerObj)
	{
		// ===========
		// Draw scene
		// ===========
